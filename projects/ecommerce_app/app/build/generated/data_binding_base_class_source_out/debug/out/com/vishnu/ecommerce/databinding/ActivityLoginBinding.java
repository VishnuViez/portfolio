...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton btnSkipLogin;
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnLogin,
      @NonNull MaterialButton btnSkipLogin, @NonNull TextInputEditText etEmail,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnSkipLogin;
      MaterialButton btnSkipLogin = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, btnSkipLogin, etEmail,
          etName, etPassword, progressBar, tilEmail, tilName, tilPassword, tvRegister, tvTitle);
    }

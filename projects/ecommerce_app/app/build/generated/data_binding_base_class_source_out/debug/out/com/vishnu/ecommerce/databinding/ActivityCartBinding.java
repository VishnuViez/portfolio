...
public final class ActivityCartBinding implements ViewBinding {
  ...
  private ActivityCartBinding(@NonNull CoordinatorLayout rootView,
      @NonNull MaterialButton btnCheckout, @NonNull RecyclerView rvCart,
      @NonNull MaterialToolbar toolbar, @NonNull TextView tvEmptyCart, @NonNull TextView tvTotal) {
  ...
  public static ActivityCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCartBinding((CoordinatorLayout) rootView, btnCheckout, rvCart, toolbar,
          tvEmptyCart, tvTotal);
    }

...
public final class ActivityOrdersBinding implements ViewBinding {
  ...
  private ActivityOrdersBinding(@NonNull CoordinatorLayout rootView, @NonNull RecyclerView rvOrders,
      @NonNull MaterialToolbar toolbar, @NonNull TextView tvEmptyOrders) {
  ...
  public static ActivityOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOrdersBinding((CoordinatorLayout) rootView, rvOrders, toolbar,
          tvEmptyOrders);
    }
